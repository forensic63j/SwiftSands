...
namespace SwiftSands
{
	class Enemy:Character
	{
        ...
        public Enemy(int maxHealth, int health, int maxMana, int mana, int speed, int strength, int accuracy, int movementrange, int level, bool canJoin,
            int exp, Texture2D texture, Rectangle pos, bool active, String n)
            : base(maxHealth, health, maxMana, mana, speed, strength, accuracy, movementrange, level, canJoin, texture, pos, active, n)
        {
